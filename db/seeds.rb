...
Ecommerce.create(user_id: 1,
                ...
                site_link_uk: "http://amzn.to/2EdLLnr",
                site_link_ca: "http://amzn.to/2FEwGbB",
                # site_link_jp: "",
                price_before: "144.99",
                price_after: "140.00",
...
Ecommerce.create(user_id: 1, 
                ...
                site_link_uk: "http://amzn.to/2BTbj3V",
                site_link_ca: "http://amzn.to/2nGqfNX",
                # site_link_jp: "",
                price_before: "49.99",
                price_after: "22.99",
...
Ecommerce.create(user_id: 1,
                ...
                site_link_uk: "http://amzn.to/2E0rbaZ",
                site_link_ca: "http://amzn.to/2s64fRT",
                # site_link_jp: "",
                price_before: "24.99",
                price_after: "19.99",
...
Ecommerce.create(user_id: 1, 
                ...
                site_link_uk: "http://amzn.to/2E1FcoQ",
                site_link_ca: "http://amzn.to/2EDI87T",
                # site_link_jp: "",
                price_before: "435.00",
                price_after: "345.00",
...
Ecommerce.create(user_id: 1,
                ...
                site_link_uk: "http://amzn.to/2E2023h",
                site_link_ca: "http://amzn.to/2FIrh3t",
                # site_link_jp: "",
                price_before: "0.0",
                price_after: "59.95",
...
Ecommerce.create(user_id: 1, 
                ...
                # site_link_uk: "",
                site_link_ca: "http://amzn.to/2DZtqHw",
                # site_link_jp: "",
                price_before: "0.0",
                price_after: "33.95",
...
Ecommerce.create(user_id: 1, 
                ...
                site_link_uk: "http://amzn.to/2E01nvx",
                site_link_ca: "http://amzn.to/2FH7kd3",
                # site_link_jp: "",
                price_before: "179.99",
                price_after: "139.97",
...
Ecommerce.create(user_id: 1, 
                ...
                site_link_uk: "http://amzn.to/2FKsuHj",
                site_link_ca: "http://amzn.to/2GJHoPk",
                # site_link_jp: "",
                price_before: "99.99 ",
                price_after: "82.95",
...
Ecommerce.create(user_id: 1, 
                ...
                site_link_uk: "http://amzn.to/2E1FuMs",
                site_link_ca: "http://amzn.to/2nGKmvp",
                # site_link_jp: "",
                price_before: "0.0",
                price_after: "199.99",
...
Ecommerce.create(user_id: 1, 
                ...
                # site_link_uk: "",
                site_link_ca: "http://amzn.to/2nIjb39",
                # site_link_jp: "",
                price_before: "0.0",
                price_after: "99.99",
...
Ecommerce.create(user_id: 1, 
                ...
                site_link_uk: "http://amzn.to/2EDI9Jh",
                site_link_ca: "http://amzn.to/2EELffZ",
                # site_link_jp: "",
                price_before: "199.00",
                price_after: "149.99",
...
Ecommerce.create(user_id: 1, 
                ...
                site_link_uk: "http://amzn.to/2DY61Kx",
                site_link_ca: "http://amzn.to/2ECFwY2",
                # site_link_jp: "",
                price_before: "249.00",
                price_after: "199.00",
...
Ecommerce.create(user_id: 1, 
                ...
                site_link_uk: "http://amzn.to/2E1VFJK",
                site_link_ca: "http://amzn.to/2GJYQmR",
                # site_link_jp: "",
                price_before: "42.42",
                price_after: "29.95",
...
Ecommerce.create(user_id: 1, 
                  ...
                  image_main: "https://i.pinimg.com/564x/9e/43/13/9e4313fd8a41f52d9e5ceb3eb357bcbf.jpg", 
                  ...
                  image_03:"https://i.pinimg.com/564x/e2/e0/35/e2e0353ce9fc9400f78293e44447bc51.jpg",
                  ...
                  # site_link_uk: "",
                  site_link_ca: "http://amzn.to/2s4Rgjt",
                  # site_link_jp: "",
                  price_before: "0.0",
                  price_after: "14.95",
...
Ecommerce.create(user_id: 1, 
                  ...
                  # site_link_uk: "",
                  site_link_ca: "http://amzn.to/2BSBfwC",
                  # site_link_jp: "",
                  price_before: "169.95",
                  price_after: "149.99",
...
Ecommerce.create(user_id: 1, 
                  ...
                  site_link_uk: "http://amzn.to/2DXDe4F",
                  # site_link_ca: "",
                  # site_link_jp: "",
                  price_before: "149.95",
                  price_after: "115.36",
...
Ecommerce.create(user_id: 1, 
                  ...
                  # site_link_uk: "",
                  site_link_ca: "http://amzn.to/2BTwHGv",
                  # site_link_jp: "",
                  price_before: "299.00",
                  price_after: "297.00",
...
Ecommerce.create(user_id: 1, 
                  ...
                  site_link_uk: "http://amzn.to/2E3cBvf",
                  site_link_ca: "http://amzn.to/2nFOyLP",
                  # site_link_jp: "",
                  price_before: "129.95",
                  price_after: "115.88",
...
Ecommerce.create(user_id: 1, 
                  ...
                  site_link_uk: "http://amzn.to/2nBB4Bt",
                  site_link_ca: "http://amzn.to/2E1W3ba",
                  # site_link_jp: "",
                  price_before: "149.99",
                  price_after: "109.99",
...
Ecommerce.create(user_id: 1, 
                  ...
                  site_link_uk: "http://amzn.to/2EelyF6",
                  site_link_ca: "http://amzn.to/2EEndSq",
                  # site_link_jp: "",
                  price_before: "0.0",
                  price_after: "29.99",
...
Ecommerce.create(user_id: 1, 
                  ...
                  site_link_uk: "http://amzn.to/2Ed7SdD",
                  site_link_ca: "http://amzn.to/2E1WfHq",
                  # site_link_jp: "",
                  price_before: "34.99",
                  price_after: "29.96",
...
Ecommerce.create(user_id: 1, 
                  ...
                  site_link_uk: "http://amzn.to/2GLV0tm",
                  site_link_ca: "http://amzn.to/2GK856E",
                  # site_link_jp: "",
                  price_before: "0.0",
                  price_after: "27.00",
...
Ecommerce.create(user_id: 1, 
                  ...
                  image_main: "https://i.pinimg.com/564x/99/a1/fc/99a1fcb7ac57d0a1c6ea8966726f8c6d.jpg", 
                  image_01:"https://i.pinimg.com/564x/2c/83/d4/2c83d496388b9e3478eacb327e25aff9.jpg",
                  ...
                  site_link_uk: "http://amzn.to/2FG4e9q",
                  site_link_ca: "http://amzn.to/2GIK9jQ",
                  # site_link_jp: "",
                  price_before: "0.0",
                  price_after: "45.00",
...
Ecommerce.create(user_id: 1, 
                  ...
                  pcategory_id: 4,
                  title: "PRVKE 21",
                  image_main: "https://i.pinimg.com/564x/d1/11/e8/d111e8236d2ef4c04708aa09d33122f4.jpg", 
                  image_01:"https://i.pinimg.com/564x/77/ef/60/77ef60285eb09839df72d29be05cc3af.jpg",
                  image_02:"https://i.pinimg.com/564x/32/e4/b8/32e4b8c222e69d1f1e5d6ea0452bcc87.jpg",
                  image_03:"https://i.pinimg.com/564x/25/d5/06/25d5069842749fbac32d056a821b20b7.jpg",
                  ...
                  # site_link_uk: "",
                  site_link_ca: "http://amzn.to/2nEVGrZ",
                  # site_link_jp: "",
                  price_before: "0.0",
                  price_after: "264.00",
...
Ecommerce.create(user_id: 1, 
                  ...
                  pcategory_id: 4,
                  title: "UNO II",
                  image_main: "https://i.pinimg.com/564x/a2/ca/c3/a2cac361a11810daecb4dff5c0851af0.jpg", 
                  image_01:"https://i.pinimg.com/564x/4c/7a/ee/4c7aee863536fe20e3422d37ffbb59c8.jpg",
                  image_02:"https://i.pinimg.com/564x/47/c9/42/47c94242ad29bba176228a1c9fbcb348.jpg",
                  image_03:"https://i.pinimg.com/564x/41/2c/aa/412caae31a1f69ab4f89a9e320d24bdf.jpg",
                  image_04:"https://i.pinimg.com/originals/0f/eb/30/0feb3032e419c58da987276981d38aff.gif",
                  sources: "via Amazon",
                  ...
                  site_link_uk: "http://amzn.to/2E3eHiw",
                  site_link_ca: "http://amzn.to/2nEVOaX",
                  # site_link_jp: "",
                  price_before: "0.0",
                  price_after: "69.99",
...
Ecommerce.create(user_id: 1, 
                  ...
                  image_02:"https://ksr-ugc.imgix.net/assets/015/930/836/7269ccaebc699b714c3241c45ead36c3_original.gif?w=680&fit=max&v=1489999139&auto=format&gif-q=50&q=92&s=e84cade149eb7f0ce41b21d2a222908ahttps://ksr-ugc.imgix.net/assets/015/930/836/7269ccaebc699b714c3241c45ead36c3_original.gif?w=680&fit=max&v=1489999139&auto=format&gif-q=50&q=92&s=e84cade149eb7f0ce41b21d2a222908a",
                  image_03:"https://i.pinimg.com/originals/e5/d5/8c/e5d58cc6e8e8d5bfe676b8c7359ccb83.gif",
                  image_04:"https://i.pinimg.com/originals/c8/69/08/c86908e6dafeccff7dcf794be43a73a9.gif",
                  sources: "via Amazon",
                  ...
                  site_link_uk: "http://amzn.to/2GM2Lj8",
                  site_link_ca: "http://amzn.to/2EEsHfI",
                  # site_link_jp: "",
                  price_before: "198.00",
                  price_after: "159.00",
...
Ecommerce.create(user_id: 1, 
                  ...
                  image_main: "https://i.pinimg.com/564x/82/0f/f5/820ff5a05483a4db7b0d405bec09509c.jpg", 
                  image_01:"https://i.pinimg.com/564x/75/aa/22/75aa22b7c2f4f5e4fcaac363393cbbfd.jpg",
                  image_02:"https://i.pinimg.com/564x/ec/2e/22/ec2e224d300ae0493150b122a804f0a0.jpg",
                  ...
                  # site_link_uk: "",
                  site_link_ca: "http://amzn.to/2ECCwL9",
                  # site_link_jp: "",
                  price_before: "0.0",
                  price_after: "29.99",
...
Ecommerce.create(user_id: 1, 
                  ...
                  site_link_uk: "http://amzn.to/2nGeZBf",
                  site_link_ca: "http://amzn.to/2EEtf5g",
                  # site_link_jp: "",
                  price_before: "149.99",
                  price_after: "99.99",
...
Ecommerce.create(user_id: 1, 
                  ...
                  image_03:"https://i.pinimg.com/564x/96/0f/36/960f36773246cbdce60ba4910861e22c.jpg",
...
Ecommerce.create(user_id: 1, 
                  ...
                  image_02:"https://i.pinimg.com/564x/70/ce/89/70ce898d459932943a1818fc2f9305d7.jpg",
                  image_03:"https://i.pinimg.com/originals/d0/7d/76/d07d76e145418a12700297f61358449d.gif",
                  ...
                  site_link_uk: "http://amzn.to/2E0VgXK",
                  site_link_ca: "http://amzn.to/2EEVfpD",
                  # site_link_jp: "",
                  price_before: "0.0",
                  price_after: "16.99",
...
Ecommerce.create(user_id: 1, 
                  ...
                  image_01:"https://i.pinimg.com/564x/6c/d2/a2/6cd2a25ef60325cfa78743fa0a719574.jpg",
                  ...
                  site_link_uk: "http://amzn.to/2DYb0e0",
                  site_link_ca: "http://amzn.to/2DZ4lMx",
                  # site_link_jp: "",
                  price_before: "24.95",
                  price_after: "19.95",
...
Ecommerce.create(user_id: 1, 
                  ...
                  image_main: "https://i.pinimg.com/564x/31/2c/88/312c88e40f93258735dc59e63a44cbd8.jpg", 
                  image_01:"https://ruggie.co/wp-content/uploads/2017/02/Ruggie3-Optimized-2.jpg",
                  image_02:"https://i.pinimg.com/originals/7d/cf/2a/7dcf2adf3efdbed1a66482d1231cc5d6.gif",
                  image_03:"https://i.pinimg.com/originals/e8/5d/93/e85d93ac3e158ae564129d2ce68cd59a.gif",
                  image_04:"https://i.pinimg.com/originals/93/e2/00/93e20065575cabfadd4ba6980d54ecfa.gif",
                  sources: "via Amazon",
...
Ecommerce.create(user_id: 1, 
                  ...
                  site_link_uk: "http://amzn.to/2GMDZiC",
                  site_link_ca: "http://amzn.to/2FFzvZO",
                  # site_link_jp: "",
                  price_before: "0.0",
                  price_after: "49.93",
...
Ecommerce.create(user_id: 1, 
                 category_id: 3,
                 pcategory_id: 2,
                 title: "KNZ GoDuo speakers",
                 image_main: "https://npzpxd1tftm5wn1j-zippykid.netdna-ssl.com/wp-content/uploads/2017/06/KNZ-GoDuo-Magnet.jpg", 
                 image_01:"http://www.gadgetgram.com/wp-content/uploads/2017/05/GoDuo-Speakers.jpg",
                 image_02:"http://www.gadgetgram.com/wp-content/uploads/2017/05/GoDuo-Speakers-3-1024x540.jpg",
                 image_03:"https://i.pinimg.com/originals/8e/37/f6/8e37f65e59f2375082a9ae6a9bd43858.jpg",
                 image_04:"https://thegadgetflow.com/wp-content/uploads/2017/05/GoDuo-Powerful-Magnetic-Stereo-Speakers-02.jpg",
                 sources: "via Amazon",
                 intro: "KNZ GoDuo speakers are designed to optimize your indoor and outdoor audio experience. 
                         Their contemporary industrial design and detailed sound quality make them the perfect desktop audio delivery system. Their loud output, enhanced bass and water-resistant design also make them an ideal companion for outdoor activities.",
                 site_link: "http://amzn.to/2EqIFfQ",
                 # site_link_uk: "",
                 site_link_ca: "http://amzn.to/2C0slNJ",
                 # site_link_jp: "",
                 price_before: "0.0",
                 price_after: "99.99",
                 youtube_link_01: "https://www.youtube.com/embed/LlSqW762UNk",
                 youtube_link_02: "https://www.youtube.com/embed/IbtyWaJnFb0bundle exec rake assets:precompile RAILS_ENV=production",
                 description: "Unlike any other speaker on the market, KNZ GoDuo speakers have a magnetic connectable base to perform as one pill-shaped speaker, or as two individual L/R speakers perfect for listening at home or on the go! They can be attached to any steel or iron surface, such as shelves, tables, your refrigerator door, and so much more. The magnetic base will change the way you enjoy your music!",      
                 description_01: "Magnetic Connectable - Each speaker is magnetized and can be attached to any steel and iron surfaces such as shelves, tables, your refrigerator door, and so much more.",
                 description_02: "Water and Shock Resistant - Precise mechanical design, high-quality polycarbonate shell and metal base make GoDuo speakers strong and reliable for outdoor activities. The carrying cover provides more protection from shock and scratching, which makes KNZ GoDuo speakers the perfect companion for life on the go.",
                 description_03: "3D Sound On the Go - KNZ GoDuo speakers are easy to adjust for an optimal surrounding audio experience and ultimate convenience. The spatially separated left and right channels boost the delivery of real stereo effects.",
                 description_04: "Ideal for Outdoor Activities - KNZ GoDuo speakers, along with their carrying case, are designed to fit into a bicycle’s water bottle holder.
                                  With built-in high-capacity battery, GoDuo can easily last the whole day-trip with intense usage without recharging.",
                 description_05: "Extremely Portable - With a hanging ring design, the speakers can be carried with comfort, easily attached to a backpack, or mounted with a carabiner.") 
...
#                  pcategory_id: 2,
#                  title: "Bookniture",
#                  image_main: https://goo.gl/jDCN9z"", 
#                  image_01:"https://goo.gl/f2sv21",
#                  image_02:"https://goo.gl/pszN8R",
#                  image_03:"https://goo.gl/qEjjD6",
#                  image_04:"https://goo.gl/dvxQXh",
#                  sources: "via Amazon",
#                  intro: "Furniture Hidden in a Book. BOOKNITURE can be used in endless ways: it can be a stool, a foot rest, a nightstand, a standing work desk... and much more! ",
#                  site_link: "http://amzn.to/2Ez0I3N",
#                  site_link_uk: "",
#                  site_link_ca: "",
#                  site_link_jp: "",
#                  price_before: "0.0",
#                  price_after: "89.00",
#                  youtube_link_01: "https://www.youtube.com/embed/Gg3-GCMCfig",
#                  youtube_link_02: "https://www.youtube.com/embed/Q3o731jTj4s",
#                  description: "Stack them up and make a table & chair set; Add a wood board on top of 2 BOOKNITUREs to make it a bench; Stack a few more layers and it becomes a shelf! The possibilities with BOOKNITURE are endless. As long as you don't limit your imagination! BOOKNITURE is also lightweight and portable. Fold it back into a book and take it anywhere! BOOKNITURE makes sure you can sit anywhere in style and comfort.",      
#                  description_01: "Light and portable furniture.",
#                  description_02: "Engineered for Strength: origami structure can withstand half ton of weight. The composite paper panels are strong with good resistant to water and moisture.",
#                  description_03: "Use in endless ways: can be a stool, foot rest, nightstand, stacking shelves and much more...",
#                  description_04: "Hidden in shelf: store or carry it around just like a book.",
#                  description_05: "A two-tone colours felt top is included (i.e. Dark Grey/ Black).") 
